...
export const Navbar: FC = async ({}) => {
  ...
  return (
    <>
      ...
      <nav className="fixed inset-x-0 bottom-0 z-50 flex h-[var(--nav-height)] items-center justify-center gap-10 rounded-t-2xl bg-white text-black-dark drop-shadow-light before:absolute before:z-[-1] before:h-20 before:w-20 before:rounded-full before:bg-white dark:bg-black dark:text-white-light dark:drop-shadow-dark before:dark:bg-black md:top-0 md:rounded-none">
        <ThemeSwitcher className="absolute bottom-3 right-3 flex flex-col items-center justify-center gap-3 md:bottom-0 md:top-3" />
