...
export default async function RootLayout({
  ...
  return (
    <html lang={validLocale} className={quicksandFont.className}>
      <body className="bodyGradient relative flex h-full min-h-screen flex-col-reverse bg-fixed text-base font-medium text-black antialiased dark:text-white md:flex-col">
