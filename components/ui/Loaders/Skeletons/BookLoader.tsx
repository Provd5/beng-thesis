...
export const BookLoader: FC = ({}) => {
  return (
    <div className="mt-3 flex-col">
      <div className="flex flex-col gap-x-10 gap-y-8 px-1 md:flex-row md:justify-between md:px-6">
        <div className="flex gap-3">
          <div className="flex size-fit animate-pulse">
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="h-7 w-12 rounded bg-colors-gray" />
            </div>
          </div>
        </div>
        <div className="flex flex-wrap justify-center gap-x-1 gap-y-4 md:justify-end">
          <div
            className="flex h-fit animate-pulse flex-col items-start justify-center gap-4"
