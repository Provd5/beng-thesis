  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex h-9">
        <button
          className="h-full w-10 rounded-l-md bg-colors-gray text-lg font-semibold text-white transition-colors hover:bg-colors-red/70"
          type="button"
          onClick={() => (
        ...
        <input
          ...
          className="w-10 appearance-none bg-white px-1 py-2 text-center text-lg text-black"
        />
        <button
          className="h-full w-10 rounded-r-md bg-colors-gray text-lg font-semibold text-white transition-colors hover:bg-colors-green/70"
          type="button"
          onClick={() => (
