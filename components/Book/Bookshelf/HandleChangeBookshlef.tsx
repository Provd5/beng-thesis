...
export const HandleChangeBookshlef: FC<HandleChangeBookshlefProps> = ({
  ...
  return (
    <div
      className="relative flex h-fit min-h-[60px] w-[132px] cursor-pointer select-none rounded-md bg-white/90 p-1 transition-colors hover:bg-colors-gray/10 dark:bg-black/30 hover:dark:bg-white/10"
      onClick={(e) =>
    ...
    >
      <div className="flex">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col">
            <p className="-mt-1 ml-1 whitespace-nowrap text-sm">
